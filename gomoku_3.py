...
class AI(object):
    ...
    def go(self, chessboard):
        ...
        if len(idx) == 225:
            ...
            if new_pos == (-1, -1):
                minimax_result = self.minimax(self.chessboard, self.depth, -1, MAX*100, self.current, [])
    ...
    def emergency_check(self):
        ...
        for point in candidate:
            ...
            if defense_score >= 1000 or attack_score >= 1000:
                if attack_score >= FREE_FOUR and emergency < MAX:
    ...
    def evaluate(self, tracing):
        ...
        for point in tracing:
            ...
            if i % 2 == 0:
                result += (self.assess(point, 0 - color, temp_board) + self.assess(point, color, temp_board))
            i += 1
        return result
